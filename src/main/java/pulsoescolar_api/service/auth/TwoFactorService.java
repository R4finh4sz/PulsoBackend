...
public class TwoFactorService {
    ...
    public void issue(AuthSession session) {
        ...
        session.setCodeExpiresAt(clock.instant().plusSeconds(600)); //Tempo de expiração do código de 10 minutos
        session.setResendAvailableAt(clock.instant().plusSeconds(180)); //Tempo de espera de 3 minutos para reenvio do código
